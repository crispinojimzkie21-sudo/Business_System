    ...
    <div class="max-w-7xl mx-auto p-6">
        ...
        <header class="flex items-center justify-between mb-8">
            ...
            <div class="flex items-center gap-4">
                ...
                <a href="{{ Auth::user()->role === 'super_admin' ? route('eload.add-load') : route('admin.eload.add-load') }}" class="px-3 py-2 bg-purple-600 hover:bg-purple-500 rounded">➕ Add Load</a>
        ...
        <!-- Filters -->
        <form method="GET" action="{{ Auth::user()->role === 'super_admin' ? route('eload.transactions.history') : route('admin.eload.transactions.history') }}" class="bg-black/60 p-4 rounded-lg border border-purple-900/30 mb-6">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div class="flex items-end gap-2">
                    ...
                    <a href="{{ Auth::user()->role === 'super_admin' ? route('eload.transactions.history') : route('admin.eload.transactions.history') }}" class="px-4 py-2 bg-gray-700 hover:bg-gray-600 rounded">Clear</a>
                </div>
            </div>
        </form>
                        ...
                        <tr class="hover:bg-purple-900/20">
                            ...
                            <td class="px-4 py-3">
                                ...
                                @elseif($transaction->status === 'pending')
                                    <span class="px-2 py-1 bg-yellow-900/50 text-yellow-400 rounded text-sm">Pending</span>
                                @else
                                    <span class="px-2 py-1 bg-red-900/50 text-red-400 rounded text-sm">Failed</span>
                                @endif
                            </td>
