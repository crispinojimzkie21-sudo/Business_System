...
<head>
    ...
    <title>Add Load - {{ config('app.name') }}</title>
...
<body class="bg-gradient-to-br from-gray-900 via-purple-900 to-violet-900 min-h-screen text-white">
    <div class="max-w-md mx-auto p-6">
        <!-- Header -->
        <header class="mb-6">
            <h1 class="text-2xl font-bold text-purple-400">📱 Add Load</h1>
        ...
        <form method="POST" action="{{ Auth::user()->isSuperAdmin() ? route('eload.process-load') : route('admin.eload.process-load') }}" class="bg-black/60 p-6 rounded-lg border border-purple-900/30">
            ...
            <div class="mb-4">
                ...
                <p class="text-xs text-purple-300 mt-1">Enter the network provider name</p>
            </div>
            ...
            <div class="mb-4">
                ...
                <p class="text-xs text-purple-300 mt-1">Enter the mobile number to receive the load</p>
            </div>
            ...
            <div class="mb-4">
                ...
                <p class="text-xs text-purple-300 mt-1">Enter the amount of load</p>
            </div>
